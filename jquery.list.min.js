...
b;f.fakeHeader.html(g.html());i.trigger("headingChange",[b,g]);i.data("list",f)}else f.wrapper.stop().animate({scrollTop:h},a,c,d)}})},option:function(b,a){var c=e(this),d=c.data("list");if(d){if(typeof b=="undefined")return d.settings;if(!b in d.settings)return false;if(typeof a=="undefined")return d.settings[b];else{d.settings[b]=a;return c}}},version:function(b){if(b){var a="1.2.1".split(".");b=(Number(a[0])||1)+"";var c=(Number(a[1])||0)+"";a=(Number(a[2])||0)+"";return Number("000".slice(0,3-
...
b+" does not exist on jQuery.list")};e.list={};e.list.log=function(b){if(b!==undefined)k=b;return k}})(jQuery);
